...
class ProjectSelectionDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.project_cards = []  # Track project cards
        self.category_cards = []  # Track category cards
        
        # Color palette matching welcome_window
        self.colors = {
            'dark_bg': '#0f0f23',
            'darker_bg': '#151622',
            'darkest_bg': '#0b1020',
    ...
    def setup_ui(self):
        ...
        # Categories area (initially hidden)
    ...
    def on_category_selected(self, card):
        # Reset previous category selection
