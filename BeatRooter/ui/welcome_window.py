...
class WelcomeWindow(QMainWindow):
    project_selected = pyqtSignal(str, str, str)
    ...
    def __init__(self):
        ...
        self.project_templates = {
            ...
            "sandbox": {
                "name": "Sandbox Mode",
                "description": "Build complete technical environments with hierarchical objects",
                "color": '#10b981',
                "gradient": f"qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #10b981, stop:1 #34d399)",
                "icon": "SB",
                "categories": {
                    "network_topology": {
                        "name": "Network Topology",
                        "description": "Design complete network infrastructures with devices and systems",
                        "icon": "NT",
                        "color": "#059669"
                    },
                    "web_architecture": {
                        "name": "Web Architecture", 
                        "description": "Model web applications and their technical components",
                        "icon": "WA",
                        "color": "#0891b2"
                    },
                    "operative_system": {
                        "name": "Operating System",
                        "description": "Test your system and security analysis tools in isolated OS environments",
                        "icon": "OS",
                        "color": "#7c3aed"
                    }
                }
    ...
    def create_option_card(self, title, description, button_text, callback, color, enabled=True):
        ...
        description = f"{description}\n\nIncludes: ExifTool, Nmap, Gobuster, Sublist3r, Whois, NSLookup"
