...
class WSLHandler:
    ...
    def fix_gobuster_command(command_parts):
        """Corrige o comando do Gobuster para usar wordlists disponíveis no WSL"""
        try:
            # Primeiro, verificar se o usuário já especificou uma wordlist
            has_wordlist = False
            wordlist_index = -1
            ...
            # Se não tem wordlist válida, procurar alternativas
            if not has_wordlist:
                possible_wordlists = [
                    '/usr/share/dirb/wordlists/common.txt',  # ← CAMINHO CORRETO
                    '/usr/share/dirb/wordlists/big.txt',
                    '/usr/share/dirb/wordlists/small.txt',
                    '/usr/share/wordlists/dirb/common.txt',  # Fallback antigo
                ...
                # Se nenhuma wordlist foi encontrada, usar a padrão do dirb
                if not has_wordlist:
            ...
            # Fallback para o caminho correto
    ...
    def check_wordlist_availability():
        """Verifica wordlists disponíveis no WSL"""
        wordlists = [
            '/usr/share/dirb/wordlists/common.txt',  # ← CAMINHO CORRETO
            '/usr/share/dirb/wordlists/big.txt',
            '/usr/share/dirb/wordlists/small.txt',
