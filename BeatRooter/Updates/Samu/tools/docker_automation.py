...
class DockerEnvironmentGenerator:
    ...
    def generate_project_structure(self):
        """Gera a estrutura completa do projeto"""
...
"""
    ...
    def _generate_database_init(self):
        init_sql = """-- Este arquivo será executado automaticamente quando o container do PostgreSQL iniciar
