...
class SandboxManager:
    ...
    def add_connection(self, source_id: str, target_id: str, connection_type: str = "network"):
        if (source_id in self.environment.objects and 
            ...
            source = self.environment.objects[source_id]
            target = self.environment.objects[target_id]
    ...
    def remove_connection(self, connection_id: str):
        for obj in self.environment.objects.values():
            if connection_id in obj.connections:
                obj.remove_connection(connection_id)
