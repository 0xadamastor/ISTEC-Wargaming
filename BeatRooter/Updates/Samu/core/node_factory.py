# node_factory.py - COMPLETO ATUALIZADO
...
class NodeFactory:
    ...
    def create_node_data(cls, node_type: str, custom_data: dict = None, category: str = None) -> dict:
        ...
        for cat in cls.CATEGORY_TEMPLATES:
            if node_type in cls.CATEGORY_TEMPLATES[cat]:
                default_data = cls.CATEGORY_TEMPLATES[cat][node_type]['default_data'].copy()
                if custom_data:
                    default_data.update(custom_data)
                return default_data
    ...
    @classmethod
    def find_node_category(cls, node_type: str) -> str:
        for category in cls.CATEGORY_TEMPLATES:
            if node_type in cls.CATEGORY_TEMPLATES[category]:
                return category
        return None