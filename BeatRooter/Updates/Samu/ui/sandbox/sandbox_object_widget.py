...
class SandboxObjectWidget(QGraphicsObject):
    ...
    def load_icon(self):
        if self.object.object_type.value == 'code_file' and self.object.code_content:
            ...
            icon_path = self.get_language_specific_icon(language)
    ...
    def get_language_specific_icon(self, language):
        base_path = "assets/icons/languages"
        ...
        icon_file = language_icons.get(language, 'code_file.png')
    ...
    def get_icon_path(self):
        ...
        icon_file = icon_mapping.get(self.object.object_type.value, 'default.png')
        return os.path.join(base_path, icon_file)
