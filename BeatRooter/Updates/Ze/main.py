import sys
import os
from PyQt6.QtWidgets import QApplication, QWidget, QHBoxLayout, QMessageBox, QSplashScreen, QMainWindow
from PyQt6.QtCore import QSettings, Qt, QTimer
from PyQt6.QtGui import QPixmap, QIcon
from ui.welcome_window import WelcomeWindow
from ui.welcome_small_menu import WelcomeSmallMenu
...
def main():
    ...
    def show_main_interface():
        ...
        if has_last_project:
            ...
            welcome.project_selected.connect(on_project_selected)
            welcome.show()    # Show splash screen for 3 seconds, then show main interface
    if splash:
